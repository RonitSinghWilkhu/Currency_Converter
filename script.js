...
const currencyConvertor = document.querySelector('.currency-convertor');

//array for select tags
const countries = [
...
const getExchangeRate = async () => {
    ...
    const convertedAmount = (amount*conversionRate).toFixed(5);
     
    if(typeof conversionRate === 'undefined'){
        resultElement.textContent = "exchange rate data is not available";
        ...
        currencyConvertor.innerHTML= `<h2>Error while fetching the details!!</h2>`;
    }
    
}
//fetching exchange rate when user fetches the currency
